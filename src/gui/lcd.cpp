...
#define LCD_SEP_H   2  // horizontal space between the LCD characters
#define LCD_SEP_V   2  // vertical space between the LCD characters
#define LCD_CHAR_H  14  // char height in pixels
#define LCD_CHAR_W  10  // char width in pixels
